...
def syntenicStructure(): #input N or K for subgenome, will generalize later
    ...
    if int(writeFastaOut):
        ...
        finalSyntenyStructureBed = finalSyntenyStructureBed.sort().merge(o='distinct',c=4,delim='|',d=100) ### Sean commented this part! Copied direct below but without merge
